#ifndef XPOD_QLEVER_PHYSICAL_TRANSITIVE_PATH_CONTEXT_BRIDGE_HPP
#define XPOD_QLEVER_PHYSICAL_TRANSITIVE_PATH_CONTEXT_BRIDGE_HPP
...
std::optional<Id> physicalTransitivePathSideIdFromContext(
