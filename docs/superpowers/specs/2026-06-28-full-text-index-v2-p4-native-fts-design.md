...
- P4 is a physical backend upgrade. It must not introduce public QLever syntax, public PostgreSQL FTS syntax, or new durable Solid model semantics.
...
- Do not expose `tsquery`, `MATCH`, QLever TextSearch syntax, or backend-specific operators as product APIs.
