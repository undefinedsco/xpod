...
- QLever upstream `IndexScan::computeSizeEstimate()` / `getScanSpecAndBlocks()` / `getLazyScan(...)` overlay patch: [`native/postgres/qlever_adapter/patches/qlever-indexscan-physical-lazy-scan.patch`](../../../native/postgres/qlever_adapter/patches/qlever-indexscan-physical-lazy-scan.patch)
