...
Make text search useful, bounded, and authorization-safe without adding embeddings, LEANN, public external native planner syntax, or a universal cost planner.
...
- external native planner is only an algorithmic reference in P0.
...
- Public external native planner/SPARQL+Text syntax.
