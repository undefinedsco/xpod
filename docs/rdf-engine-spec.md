...
5. Text / RDF / vector fusion：Agent Runtime 已有产品接入点：`RunContextRetriever`
   ...
   line-addressable RDF authority 文本 source。后续补有用户 credential 上下文的 vector
   文档索引产品入口，以及外部 vector backend 替换。
