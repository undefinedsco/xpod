...
4. Ordered-page / keyset join 与 subject-star：消息流 keyset case 和 subject-star plan marker 已先作为 models benchmark gate；2026-06-09 真实 PG17 custom rerun 已给出 native p95 对比，后续继续把 positive/negative shape 固化进 cost gate，而不是按 capability 全量切换。
