...
5. Text / RDF / vector fusion：Agent Runtime 已有产品接入点：`RunContextRetriever`
   ...
   credential 上下文的 vector 文档索引产品入口。后续补触发该 service 的 SolidFS/HTTP
   调度入口，以及外部 vector backend 替换。
