...
3. Materialized result：PG 第一版表和 lifecycle 已完成；ChatKit thread history 读路径已回到
   ...
   materialized key。下一步优先覆盖统计页和非 thread-history 的 Agent context
   materialized key。
