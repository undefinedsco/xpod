...
- `xpod_rdf_perm`, a custom index access method prototype that stores entries
  ...
  scan, vacuum cleanup, and planner path generation.
...
prototype. It proves native extension packaging, capability detection, and
custom index DDL before replacing the full index-page filtering path with
RDF-specific ordered compressed postings.
