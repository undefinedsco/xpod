...
export const PROVIDERS: AiProviderDefinition[] = [
  ...
  { id: 'kimi', name: 'Kimi', browserMode: 'deviceCodeOAuth', browserLabel: '登录', description: 'Moonshot AI 模型服务', homeUrl: 'https://www.moonshot.cn', apiKeyUrl: 'https://kimi.moonshot.cn/device', apiKeyPlaceholder: 'sk-...', defaultBaseUrl: 'https://api.moonshot.cn/v1' },
  { id: 'bailian', name: '百炼·按量', browserMode: 'browserAssistedApiKey', browserLabel: '登录', description: '阿里云百炼模型服务（按量计费）', homeUrl: 'https://www.aliyun.com/product/bailian', apiKeyUrl: 'https://bailian.console.aliyun.com/#/api-key', apiKeyPlaceholder: 'sk-...', defaultBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1' },
  { id: 'bailian-coding-plan', name: '百炼·Coding Plan', browserMode: 'browserAssistedApiKey', browserLabel: '登录', description: '阿里云百炼编程订阅套餐（仅限编程工具交互使用）', homeUrl: 'https://help.aliyun.com/zh/model-studio/coding-plan', apiKeyUrl: 'https://bailian.console.aliyun.com/cn-beijing/?tab=plan#/efm/subscription/coding-plan', apiKeyPlaceholder: 'sk-sp-...', defaultBaseUrl: 'https://coding.dashscope.aliyuncs.com/v1' },
  { id: 'bailian-token-plan', name: '百炼·Token Plan', browserMode: 'browserAssistedApiKey', browserLabel: '登录', description: '阿里云百炼 Token 节省计划（仅华北2·北京）', homeUrl: 'https://help.aliyun.com/zh/model-studio/token-plan-overview', apiKeyUrl: 'https://bailian.console.aliyun.com/cn-beijing/', apiKeyPlaceholder: 'sk-...', defaultBaseUrl: 'https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1' },
