...
import { aiConnectionExtension, AiConnectionPanel, type AiConnectionClient } from '../src'

const WEB_ID = 'https://pod.example/alice/profile/card#me'

function client(): AiConnectionClient {
  return {
    webId: WEB_ID,
...
describe('AI Connection extension', () => {
  it('publishes one stable applet contribution', () => {
    expect(aiConnectionExtension.manifest.extensionId).toBe(
      'https://undefineds.co/extensions/ai-connection',
    )
    ...
    expect(aiConnectionExtension.manifest.contributes.applets[0]?.appId).toBe(
      'https://undefineds.co/applets/ai-connection',
    )
  })
