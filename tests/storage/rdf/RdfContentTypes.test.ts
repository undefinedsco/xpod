...
describe('RdfContentTypes', () => {
  it('recognizes standard RDF document formats separately from by-line RDF formats', () => {
    ...
    expect(rdfContentTypeForPath('https://pod.example/alice/data.ttl.acr')).toBe('text/turtle');
    ...
    expect(isRdfDocumentPath('/workspace/data.ttl.acr')).toBe(true);
    expect(isLineAddressableRdfPath('/workspace/data.ttl.acr')).toBe(true);
