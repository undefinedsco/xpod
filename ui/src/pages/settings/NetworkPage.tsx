...
/**
 * The address a console-owned tunnel has to forward to: the Gateway's tunnel entry.
 *
 * It is a listener of the same Gateway that never treats a caller as local, so a tunnel
 * reaching the runtime through it cannot inherit local trust whatever headers it carries. The
 * page hands the number over ready to paste and links to the console that needs it; the
 * Gateway's own port stays what the user types in a browser.
 */
