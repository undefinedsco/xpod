...
describe('CSS identity page controllers', () => {
  ...
  it('uses the canonical Account credentials view for login and registration', async () => {
    ...
    expect(registrationCard.classList.contains('h-auto')).toBe(true);
    expect(registrationCard.classList.contains('h-[400px]')).toBe(false);
    expect(registrationCard.classList.contains('w-[320px]')).toBe(true);
    expect(registrationCard.classList.contains('w-[280px]')).toBe(false);
