...
export interface AiConnectionsInvocationKeyIssuerOptions {
 ...
 */
export class AiConnectionsInvocationKeyIssuer {
  ...
  public constructor(options: AiConnectionsInvocationKeyIssuerOptions) {
