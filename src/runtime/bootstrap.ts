...
export function buildRuntimeShorthand(
  ...
  return {
    ...withDefinedEntries([
      ...
      ['p2pApiBaseUrl', envValue('XPOD_P2P_API_BASE_URL')],
      ['p2pPollIntervalMs', envValue('XPOD_P2P_POLL_INTERVAL_MS')],
      ['p2pSignalingPollIntervalMs', envValue('XPOD_P2P_SIGNALING_POLL_INTERVAL_MS')],
      ['p2pTimeoutMs', envValue('XPOD_P2P_TIMEOUT_MS')],
