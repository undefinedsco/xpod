...
export function buildRuntimeShorthand(
  ...
  return {
    ...withDefinedEntries([
      ...
      ['p2pWinnerSelectionWindowMs', envValue('XPOD_P2P_WINNER_SELECTION_WINDOW_MS')],
      ['acmeMode', envValue('XPOD_ACME_MODE')],
      ['acmeEmail', envValue('XPOD_ACME_EMAIL')],
      ['acmeDomains', envValue('XPOD_ACME_DOMAINS')],
      ['acmeDirectoryUrl', envValue('XPOD_ACME_DIRECTORY_URL')],
      ['acmeAccountKeyPath', envValue('XPOD_ACME_ACCOUNT_KEY_PATH')],
      ['acmeCertificateKeyPath', envValue('XPOD_ACME_CERTIFICATE_KEY_PATH')],
      ['acmeCertificatePath', envValue('XPOD_ACME_CERTIFICATE_PATH')],
      ['acmeFullChainPath', envValue('XPOD_ACME_FULL_CHAIN_PATH')],
      ['acmeRenewBeforeDays', envValue('XPOD_ACME_RENEW_BEFORE_DAYS')],
